...
from ce_perm_c.mini_sci import linsolve
...
def solve_linear(A, b, iterative_method=False, perm_c=None):
    ...
    #     return _solve_direct(A, b, perm_c=perm_c)

    # force to use direct solver
    return _solve_direct(A, b, perm_c=perm_c)


def _solve_direct(A, b, perm_c=None):
    """Direct solver"""
    ...
    # else:
    #     if perm_c!=None:
    #         ans = mini_sci.linsolve.sp_solve_with_perm_c(A, b, perm_c)
    #     else:
    #         ans = mini_sci.linsolve.spsolve(A, b)
    #     # scipy solver.
    #     # ans = scipy.sparse.linalg.spsolve(A, b)
    #     return ans

    # only use mini_sci solver for test
    if perm_c is not None:
        ans = linsolve.sp_solve_with_perm_c(A, b, perm_c)
    else:
        ans = linsolve.spsolve(A, b)
    # scipy solver.
    # ans = scipy.sparse.linalg.spsolve(A, b)
    return ans
