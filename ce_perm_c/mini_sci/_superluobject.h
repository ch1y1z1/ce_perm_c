...
//    {                                                      \
//        switch(type) {                                     \
//        case NPY_FLOAT: printf("got NPY_FLOAT, calling s##name\n"); s##name(name##_ARGS_REF); break; \
//        case NPY_DOUBLE: printf("got NPY_DOUBLE, calling d##name\n"); d##name(name##_ARGS_REF); break; \
//        case NPY_CFLOAT: printf("got NPY_CFLOAT, calling c##name\n"); c##name(name##_ARGS_REF); break; \
//        case NPY_CDOUBLE: printf("got NPY_CDOUBLE, calling z##name\n"); z##name(name##_ARGS_REF); break; \
//        default: return;                                   \
//        }                                                  \
//    }
